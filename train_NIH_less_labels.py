...
# Config
# --------------------------------------------------
train_csv = "train_less_labels.csv"
val_csv = "val_less_labels.csv"
...
continue_from_best_model = False
...
save_dir = "training_outputs_less_labels"
...
def run_phase(
    ...
    while epoch < total_epochs:
        ...
        val_macro_auroc, mean_label_accuracy, per_label_aurocs = evaluate(
            ...
            device=device,
            label_names=label_names,
            phase_name=phase_name + " epoch " + str(epoch_number),
        )
